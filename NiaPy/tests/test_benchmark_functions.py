...
class TestBenchmarkFunctions(TestCase):
    ...
    def assertBounds(self, bench, lower, upper):
        ...
        b = BenchmarkUtility().get_benchmark(bench)
    ...
    def test_rastrigin(self):
        ...
        rastrigin = BenchmarkUtility().get_benchmark('rastrigin')
    ...
    def test_rosenbrock(self):
        ...
        rosenbrock = BenchmarkUtility().get_benchmark('rosenbrock')
    ...
    def test_griewank(self):
        ...
        griewank = BenchmarkUtility().get_benchmark('griewank')
    ...
    def test_sphere(self):
        ...
        sphere = BenchmarkUtility().get_benchmark('sphere')
        fun = sphere.function()
        self.assertTrue(callable(fun))
        self.assertEqual(fun(self.D, self.array), 0.0)
    ...
    def test_ackley(self):
        ...
        ackley = BenchmarkUtility().get_benchmark('ackley')
        fun = ackley.function()
        self.assertTrue(callable(fun))
    ...
    def test_schwefel(self):
        ...
        schwefel = BenchmarkUtility().get_benchmark('schwefel')
    ...
    def test_schwefel221(self):
        ...
        schwefel221 = BenchmarkUtility().get_benchmark('schwefel221')
    ...
    def test_schwefel222(self):
        ...
        schwefel222 = BenchmarkUtility().get_benchmark('schwefel222')
    ...
    def test_whitley(self):
        ...
        whitley = BenchmarkUtility().get_benchmark('whitley')
    ...
    def test_styblinskiTang(self):
        ...
        styblinskiTang = BenchmarkUtility().get_benchmark('styblinskiTang')
    ...
    def test_sumSquares(self):
        ...
        sumSquares = BenchmarkUtility().get_benchmark('sumSquares')
    ...
    def test_stepint(self):
        ...
        stepint = BenchmarkUtility().get_benchmark('stepint')
    ...
    def test_step(self):
        ...
        step = BenchmarkUtility().get_benchmark('step')
        fun = step.function()
        self.assertTrue(callable(fun))
        self.assertEqual(fun(self.D, self.array), 0.0)
    ...
    def test_step2(self):
        ...
        step2 = BenchmarkUtility().get_benchmark('step2')
        fun = step2.function()
        self.assertTrue(callable(fun))
    ...
    def test_step3(self):
        ...
        step3 = BenchmarkUtility().get_benchmark('step3')
        fun = step3.function()
        self.assertTrue(callable(fun))
        self.assertEqual(fun(self.D, self.array), 0.0)
