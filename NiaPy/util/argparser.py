...
"""Argparser implementation module."""
...
def getArgs(av):
	...
	Returns:
		Dict[str, Union[float, int, str, OptimizationType]]: Where key represents argument name and values its value.

	Note: See also
		* [MakeArgParser](#NiaPy.util.argparser.MakeArgParser)
	"""
...
def getDictArgs(argv):
	...
	Note: See also
		* [getArgs](#NiaPy.util.argparser.getArgs)
	"""
