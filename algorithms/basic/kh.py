...
class KrillHerd(Algorithm):
    ...
    def __init__(self, population_size=50, n_max=0.01, foraging_speed=0.2, diffusion_speed=0.02, c_t=0.93,
                 w_neighbor=0.4, w_foraging=0.4, d_s=26.63, max_neighbors=5, crossover_rate=0.7, mutation_rate=0.05,
                 *args, **kwargs):
