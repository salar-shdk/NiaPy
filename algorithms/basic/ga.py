...
class GeneticAlgorithm(Algorithm):
    ...
    def __init__(self, population_size=25, tournament_size=15, mutation_rate=0.2, crossover_rate=0.2,
                 selection=tournament_selection, crossover=two_point_crossover, mutation=uniform_mutation, *args, **kwargs):
