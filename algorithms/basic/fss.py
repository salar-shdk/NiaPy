...
class FishSchoolSearch(Algorithm):
    ...
    def __init__(self, population_size=30, step_individual_init=1.0, step_individual_final=0.001,
                 step_volitive_init=1.0, step_volitive_final=0.001, min_w=1.0, w_scale=500.0, *args, **kwargs):
