...
class BacterialForagingOptimization(Algorithm):
    ...
    def __init__(self, population_size=50, n_chemotactic=1, n_swim=5, n_reproduction=5, n_elimination=2,
                 prob_elimination=0.25, step_size=0.1, swarming=True, d_attract=0.1, w_attract=0.1, h_repel=0.1,
