...
class BatAlgorithm(Algorithm):
    ...
    def __init__(self, population_size=40, loudness=10.0, pulse_rate=1.0, alpha=0.97, gamma=0.1, min_frequency=0.0,
    ...
    def set_parameters(self, population_size=20, loudness=1.0, pulse_rate=1.0, alpha=0.07, gamma=0.1, min_frequency=0.0,
